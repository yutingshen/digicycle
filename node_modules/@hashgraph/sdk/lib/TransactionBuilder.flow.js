...
declare export class TransactionBuilder<O = Transaction> {
  +_inner: TransactionBody;
  _shouldSetFee: boolean;
  _node?: AccountId;
  constructor(): this;
  ...
  _method: UnaryMethodDefinition<Transaction_, TransactionResponse>;
  _doValidate(errors: string[]): void;
  validate(): void;
  getCost(client: BaseClient): Promise<Hbar>;
  build(client?: BaseClient): O;
}
declare export class SingleTransactionBuilder
  mixins TransactionBuilder<Transaction> {
  getCost(client: BaseClient): Promise<Hbar>;
  build(client?: BaseClient): Transaction;
  execute(client: BaseClient): Promise<TransactionId>;
  _method: grpc.UnaryMethodDefinition<Transaction_, TransactionResponse>;
