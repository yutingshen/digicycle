...
class TransactionResponse {
  ...
  async getReceipt(client) {
    const receipt = await new _TransactionReceiptQuery.default().setTransactionId(this.transactionId).setNodeAccountId(this.nodeId).execute(client);
  ...
  async getRecord(client) {
    ...
    return new _TransactionRecordQuery.default().setTransactionId(this.transactionId).setNodeAccountId(this.nodeId).execute(client);
  }
