...
const Network = {
  ...
  MAINNET: {
    "https://grpc-web.myhbarwallet.com": new _AccountId.default(3)
  },
  TESTNET: {
    "https://grpc-web.testnet.myhbarwallet.com": new _AccountId.default(3)
  },
  PREVIEWNET: {
    "https://grpc-web.previewnet.myhbarwallet.com": new _AccountId.default(3)
  }
};
/**
...
class WebClient extends _Client.default {
  ...
  _createNetworkChannel(address) {
    return new _WebChannel.default(address);
  }
