/**
 * Flowtype definitions for ContractFunctionParameters
 * Generated by Flowgen from a Typescript Definition
 * Flowgen v1.11.0
 */

declare export default class ContractFunctionParameters {
  /**
  ...
  /**
   * @type {$PropertyType<$Exports<"./ContractFunctionSelector.js">, "Argument">[]}
   */
  _arguments: $PropertyType<
    $Exports<"./ContractFunctionSelector.js">,
    "Argument"
  >[];
   ...
   * @returns {ContractFunctionParameters}
   */
  addUint256(value: BigNumber): ContractFunctionParameters;
 ...
 */
   ...
   * @returns {Uint8Array}
   */
  _build(name?: string | void): Uint8Array;
}
