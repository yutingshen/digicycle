...
class AccountInfo {
  ...
  static _fromProtobuf(info) {
    return new AccountInfo({
      ...
      info.expirationTime),
      autoRenewPeriod: info.autoRenewPeriod != null ? info.autoRenewPeriod.seconds instanceof _long.default ? info.autoRenewPeriod.seconds : _long.default.fromValue(info.autoRenewPeriod.seconds != null ? info.autoRenewPeriod.seconds : _long.default.ZERO) : _long.default.fromValue(0),
