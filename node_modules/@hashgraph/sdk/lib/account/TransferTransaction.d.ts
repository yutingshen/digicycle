...
import { TokenIdLike } from "../token/TokenId";
 ...
 */
export declare class TransferTransaction extends SingleTransactionBuilder {
     ...
     */
    addHbarTransfer(accountId: AccountIdLike, amount: Tinybar | Hbar): this;
    addTokenTransfer(tokenId: TokenIdLike, accountId: AccountIdLike, amount: number | BigNumber): this;
