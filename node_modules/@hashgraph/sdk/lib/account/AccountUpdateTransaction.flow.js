 ...
 */
declare export class AccountUpdateTransaction mixins SingleTransactionBuilder {
  constructor(): this;
  ...
  /**
   * @deprecated The new expiration time to extend to (ignored if equal to or before the current one).
   */
