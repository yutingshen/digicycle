/**
 * Flowtype definitions for AccountInfoQuery
...
declare export class TokenRelationshipMap {
  constructor(relationships: ProtoTokenRelationship[]): this;
  get(tokenId: TokenIdLike): TokenRelationship | void;
 ...
 */
declare export class AccountInfoQuery mixins QueryBuilder<AccountInfo> {
  constructor(): this;
  ...
  _mapResponse(response: Response): AccountInfo;
}
