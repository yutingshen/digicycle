...
declare export class AccountTokenTransfersMap {
  constructor(transfers: ProtoAccountAmount[]): this;
  get(accountId: AccountIdLike): BigNumber[] | void;
  values(): IterableIterator<BigNumber[]>;
  keys(): IterableIterator<AccountId>;
  @@iterator: () => IterableIterator<[AccountId, BigNumber[]]>;
}
declare export class TokenTransfersMap {
  constructor(transfers: ProtoTokenTransferList[]): this;
  get(tokenId: TokenIdLike): AccountTokenTransfersMap | void;
  values(): IterableIterator<AccountTokenTransfersMap>;
  keys(): IterableIterator<TokenId>;
  @@iterator: () => IterableIterator<[TokenId, AccountTokenTransfersMap]>;
}
/**
...
declare export class TransactionRecord {
   ...
   */
  +transfers: Transfer[];
  +tokenTransfers: TokenTransfersMap;
  constructor(): this;
