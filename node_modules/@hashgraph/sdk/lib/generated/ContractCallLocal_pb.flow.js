/**
 * Flowtype definitions for ContractCallLocal_pb
...
declare export class ContractLoginfo mixins jspb.Message {
...
export type ContractLoginfo$AsObject = {
...
declare export class ContractFunctionResult mixins jspb.Message {
  hasContractid(): boolean;
  clearContractid(): void;
  getContractid(): BasicTypes_pb.ContractID | void;
  setContractid(value?: BasicTypes_pb.ContractID): void;
  ...
  addCreatedcontractids(
    value?: BasicTypes_pb.ContractID,
    index?: number
  ): BasicTypes_pb.ContractID;
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ContractFunctionResult$AsObject;
  static toObject(
    includeInstance: boolean,
    msg: ContractFunctionResult
  ): ContractFunctionResult$AsObject;
  static extensions: {
    [key: number]: jspb.ExtensionFieldInfo<jspb.Message>,
    ...
  };
...
export type ContractFunctionResult$AsObject = {
  contractid?: BasicTypes_pb.ContractID.AsObject,
...
declare export class ContractCallLocalQuery mixins jspb.Message {
  hasHeader(): boolean;
  clearHeader(): void;
  ...
  static toObject(
    includeInstance: boolean,
    msg: ContractCallLocalQuery
  ): ContractCallLocalQuery$AsObject;
  static extensions: {
    [key: number]: jspb.ExtensionFieldInfo<jspb.Message>,
    ...
  };
...
export type ContractCallLocalQuery$AsObject = {
...
declare export class ContractCallLocalResponse mixins jspb.Message {
  hasHeader(): boolean;
  clearHeader(): void;
...
export type ContractCallLocalResponse$AsObject = {
