...
declare export class AccountAmount mixins jspb.Message {
  hasAccountid(): boolean;
  clearAccountid(): void;
  getAccountid(): AccountID | void;
  setAccountid(value?: AccountID): void;
...
export type AccountAmount$AsObject = {
  accountid?: AccountID$AsObject,
  amount: string,
  ...
};
...
declare export class TokenTransferList mixins jspb.Message {
  hasToken(): boolean;
  clearToken(): void;
  getToken(): TokenID | void;
  ...
  static toObject(
    includeInstance: boolean,
    msg: TokenTransferList
  ): TokenTransferList$AsObject;
  static extensions: {
    [key: number]: jspb.ExtensionFieldInfo<jspb.Message>,
    ...
  };
...
export type TokenTransferList$AsObject = {
...
declare export class TokenID mixins jspb.Message {
  getShardnum(): number;
  setShardnum(value: number): void;
  getRealmnum(): number;
  setRealmnum(value: number): void;
...
declare export class FeeComponents mixins jspb.Message {
  ...
  getVpt(): string;
  setVpt(value: string): void;
  getRbh(): string;
  setRbh(value: string): void;
  getSbh(): string;
  setSbh(value: string): void;
  getGas(): string;
  setGas(value: string): void;
  getTv(): string;
  setTv(value: string): void;
  getBpr(): string;
  setBpr(value: string): void;
  getSbpr(): string;
  setSbpr(value: string): void;
  serializeBinary(): Uint8Array;
...
declare export class NodeAddress mixins jspb.Message {
  ...
  getNodeaccountid(): AccountID | void;
...
declare export class SemanticVersion mixins jspb.Message {
  getMajor(): number;
...
export type SemanticVersion$AsObject = {
  major: number,
  minor: number,
  patch: number,
  ...
};
declare export class Setting mixins jspb.Message {
  getName(): string;
...
export type Setting$AsObject = {
  name: string,
  value: string,
  data: Uint8Array | string,
  ...
};
declare export class ServicesConfigurationList mixins jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ServicesConfigurationList
  ): ServicesConfigurationList$AsObject;
  static extensions: {
    [key: number]: jspb.ExtensionFieldInfo<jspb.Message>,
    ...
  };
...
export type ServicesConfigurationList$AsObject = {
  namevalueList: Array<Setting$AsObject>,
  ...
};
declare export class TokenRelationship mixins jspb.Message {
  hasTokenid(): boolean;
  clearTokenid(): void;
  getTokenid(): TokenID | void;
  setTokenid(value?: TokenID): void;
  getSymbol(): string;
  setSymbol(value: string): void;
  getBalance(): string;
  setBalance(value: string): void;
  getKycstatus(): $ElementType<TokenKycStatusMap, $Keys<TokenKycStatusMap>>;
  setKycstatus(
    value: $ElementType<TokenKycStatusMap, $Keys<TokenKycStatusMap>>
  ): void;
  getFreezestatus(): $ElementType<
    TokenFreezeStatusMap,
    $Keys<TokenFreezeStatusMap>
  >;
  setFreezestatus(
    value: $ElementType<TokenFreezeStatusMap, $Keys<TokenFreezeStatusMap>>
  ): void;
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TokenRelationship$AsObject;
  static toObject(
    includeInstance: boolean,
    msg: TokenRelationship
  ): TokenRelationship$AsObject;
  static extensions: {
    [key: number]: jspb.ExtensionFieldInfo<jspb.Message>,
    ...
  };
...
export type TokenRelationship$AsObject = {
  tokenid?: TokenID$AsObject,
  symbol: string,
  balance: string,
  kycstatus: $ElementType<TokenKycStatusMap, $Keys<TokenKycStatusMap>>,
  freezestatus: $ElementType<TokenFreezeStatusMap, $Keys<TokenFreezeStatusMap>>,
  ...
};
...
declare export var TokenFreezeStatus: TokenFreezeStatusMap;
export interface TokenKycStatusMap {
  KYCNOTAPPLICABLE: 0;
  GRANTED: 1;
  REVOKED: 2;
}
declare export var TokenKycStatus: TokenKycStatusMap;
