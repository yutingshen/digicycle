/**
 * Flowtype definitions for ConsensusTopicInfo_pb
...
declare export class ConsensusTopicInfo mixins jspb.Message {
  getMemo(): string;
  ...
  static toObject(
    ...
    msg: ConsensusTopicInfo
  ): ConsensusTopicInfo$AsObject;
  static extensions: {
...
export type ConsensusTopicInfo$AsObject = {
  memo: string,
