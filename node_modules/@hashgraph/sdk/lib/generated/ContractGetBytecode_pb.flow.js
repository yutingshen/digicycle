/**
 * Flowtype definitions for ContractGetBytecode_pb
...
declare export class ContractGetBytecodeQuery mixins jspb.Message {
  hasHeader(): boolean;
  clearHeader(): void;
  ...
  static toObject(
    ...
    msg: ContractGetBytecodeQuery
  ): ContractGetBytecodeQuery$AsObject;
  static extensions: {
...
export type ContractGetBytecodeQuery$AsObject = {
  header?: QueryHeader_pb.QueryHeader.AsObject,
  contractid?: BasicTypes_pb.ContractID.AsObject,
  ...
};
declare export class ContractGetBytecodeResponse mixins jspb.Message {
  hasHeader(): boolean;
  clearHeader(): void;
  ...
  static toObject(
    includeInstance: boolean,
    msg: ContractGetBytecodeResponse
  ): ContractGetBytecodeResponse$AsObject;
  static extensions: {
    [key: number]: jspb.ExtensionFieldInfo<jspb.Message>,
    ...
  };
...
export type ContractGetBytecodeResponse$AsObject = {
