/**
 * Flowtype definitions for ConsensusUpdateTopic_pb
...
declare export class ConsensusUpdateTopicTransactionBody mixins jspb.Message {
  hasTopicid(): boolean;
  clearTopicid(): void;
  ...
  hasMemo(): boolean;
  clearMemo(): void;
  getMemo(): google_protobuf_wrappers_pb.StringValue | void;
  ...
  clearSubmitkey(): void;
  getSubmitkey(): BasicTypes_pb.Key | void;
  ...
  ): ConsensusUpdateTopicTransactionBody$AsObject;
  static toObject(
    includeInstance: boolean,
    msg: ConsensusUpdateTopicTransactionBody
  ): ConsensusUpdateTopicTransactionBody$AsObject;
  static extensions: {
...
export type ConsensusUpdateTopicTransactionBody$AsObject = {
