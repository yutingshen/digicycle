...
export namespace CryptoGetInfoResponse {
  ...
  export class AccountInfo extends jspb.Message {
    ...
    getLivehashesList(): Array<CryptoAddLiveHash_pb.LiveHash>;
    setLivehashesList(value: Array<CryptoAddLiveHash_pb.LiveHash>): void;
    addLivehashes(value?: CryptoAddLiveHash_pb.LiveHash, index?: number): CryptoAddLiveHash_pb.LiveHash;

    clearTokenrelationshipsList(): void;
    getTokenrelationshipsList(): Array<BasicTypes_pb.TokenRelationship>;
    setTokenrelationshipsList(value: Array<BasicTypes_pb.TokenRelationship>): void;
    addTokenrelationships(value?: BasicTypes_pb.TokenRelationship, index?: number): BasicTypes_pb.TokenRelationship;
  ...
  export namespace AccountInfo {
    export type AsObject = {
      ...
      livehashesList: Array<CryptoAddLiveHash_pb.LiveHash.AsObject>,
      tokenrelationshipsList: Array<BasicTypes_pb.TokenRelationship.AsObject>,
    }
  }
}
