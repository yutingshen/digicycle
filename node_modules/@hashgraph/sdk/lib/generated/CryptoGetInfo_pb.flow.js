...
declare export class CryptoGetInfoResponse$AccountInfo mixins jspb.Message {
  ...
  addLivehashes(
    value?: CryptoAddLiveHash_pb.LiveHash,
    index?: number
  ): CryptoAddLiveHash_pb.LiveHash;
  clearTokenrelationshipsList(): void;
  getTokenrelationshipsList(): Array<BasicTypes_pb.TokenRelationship>;
  setTokenrelationshipsList(
    value: Array<BasicTypes_pb.TokenRelationship>
  ): void;
  addTokenrelationships(
    value?: BasicTypes_pb.TokenRelationship,
    index?: number
  ): BasicTypes_pb.TokenRelationship;
  serializeBinary(): Uint8Array;
  toObject(
    includeInstance?: boolean
