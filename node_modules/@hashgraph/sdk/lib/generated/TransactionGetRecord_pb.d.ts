...
export class TransactionGetRecordResponse extends jspb.Message {
  ...
  getDuplicatetransactionrecordsList(): Array<TransactionRecord_pb.TransactionRecord>;
  setDuplicatetransactionrecordsList(value: Array<TransactionRecord_pb.TransactionRecord>): void;
  addDuplicatetransactionrecords(value?: TransactionRecord_pb.TransactionRecord, index?: number): TransactionRecord_pb.TransactionRecord;
...
export namespace TransactionGetRecordResponse {
  export type AsObject = {
    ...
    duplicatetransactionrecordsList: Array<TransactionRecord_pb.TransactionRecord.AsObject>,
  }
}
