/**
 * Flowtype definitions for FileUpdate_pb
...
declare export class FileUpdateTransactionBody mixins jspb.Message {
  hasFileid(): boolean;
  clearFileid(): void;
  ...
  static toObject(
    ...
    msg: FileUpdateTransactionBody
  ): FileUpdateTransactionBody$AsObject;
  static extensions: {
...
export type FileUpdateTransactionBody$AsObject = {
