...
export declare class Status implements Indexed {
     ...
     */
    static readonly InvalidChunkNumber: Status;
    /**
     * For every chunk, the payer account that is part of initialTransactionID must match the Payer Account of this transaction. The entire initialTransactionID should match the transactionID of the first chunk, but this is not checked or enforced by Hedera except when the chunk number is 1.
     */
    static readonly InvalidChunkTransactionId: Status;
    /**
     * Account is frozen and cannot transact with the token
     */
    static readonly AccountFrozenForToken: Status;
    /**
     * Maximum number of token relations for agiven account is exceeded
     */
    static readonly TokensPerAccountLimitExceeded: Status;
    /**
     * The token is invalid or does not exist
     */
    static readonly InvalidTokenId: Status;
    /**
     * Invalid token decimals
     */
    static readonly InvalidTokenDecimals: Status;
    /**
     * Invalid token initial supply
     */
    static readonly InvalidTokenInitialSupply: Status;
    /**
     * Treasury Account does not exist or is deleted
     */
    static readonly InvalidTreasuryAccountForToken: Status;
    /**
     * Token Symbol is not UTF-8 capitalized alphabetical string
     */
    static readonly InvalidTokenSymbol: Status;
    /**
     * Freeze key is not set on token
     */
    static readonly TokenHasNoFreezeKey: Status;
    /**
     * Amounts in transfer list are not net zero
     */
    static readonly TransfersNotZeroSumForToken: Status;
    /**
     * Token Symbol is not provided
     */
    static readonly MissingTokenSymbol: Status;
    /**
     * Token Symbol is too long
     */
    static readonly TokenSymbolTooLong: Status;
    /**
     * KYC must be granted and account does not have KYC granted
     */
    static readonly AccountKycNotGrantedForToken: Status;
    /**
     * KYC key is not set on token
     */
    static readonly TokenHasNoKycKey: Status;
    /**
     * Token balance is not sufficient for the transaction
     */
    static readonly InsufficientTokenBalance: Status;
    /**
     * Token transactions cannot be executed on deleted token
     */
    static readonly TokenWasDeleted: Status;
    /**
     * Supply key is not set on token
     */
    static readonly TokenHasNoSupplyKey: Status;
    /**
     * Wipe key is not set on token
     */
    static readonly TokenHasNoWipeKey: Status;
    static readonly InvalidTokenMintAmount: Status;
    static readonly InvalidTokenBurnAmount: Status;
    static readonly TokenNotAssociatedToAccount: Status;
    /**
     * Cannot execute wipe operation on treasury account
     */
    static readonly CannotWipeTokenTreasuryAccount: Status;
    static readonly InvalidKycKey: Status;
    static readonly InvalidWipeKey: Status;
    static readonly InvalidFreezeKey: Status;
    static readonly InvalidSupplyKey: Status;
    /**
     * Token Name is not provided
     */
    static readonly MissingTokenName: Status;
    /**
     * Token Name is too long
     */
    static readonly TokenNameTooLong: Status;
    /**
     * The provided wipe amount must not be negative, zero or bigger than the token holder balance
     */
    static readonly InvalidWipingAmount: Status;
    /**
     * Token does not have Admin key set, thus update/delete transactions cannot be performed
     */
    static readonly TOKEN_IS_IMMUTABLE: Status;
    /**
     * An <tt>associateToken</tt> operation specified a token already associated to the account
     */
    static readonly TokenAlreadyAssociatedToAccount: Status;
    /**
     * An attempted operation is invalid until all token balances for the target account are zero
     */
    static readonly TransactionRequiresZeroTokenBalances: Status;
    /**
     * An attempted operation is invalid because the account is a treasury
     */
    static readonly AccountIsTreasury: Status;
    /**
     * Same TokenIDs present in the token list
     */
    static readonly TokenIdRepeatedInTokenList: Status;
    /**
     * Exceeded the number of token transfers (both from and to) allowed for token transfer list
     */
    static readonly TokenTransferListSizeLimitExceeded: Status;
    /**
     * TokenTransfersTransactionBody has no TokenTransferList
     */
    static readonly EmptyTokenTransferBody: Status;
    /**
     * TokenTransfersTransactionBody has a TokenTransferList with no AccountAmounts
     */
    static readonly EmptyTokenTransferAccountAmounts: Status;
    private static [0];
    private static [1];
    private static [2];
    private static [3];
